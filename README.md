...
Note, this code was developed at Stanford University, under the peculiarities of available compute systems as part of a PhD program. Apologies for the single-massive-subroutine structure - it optimized best at the time.
