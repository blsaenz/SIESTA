...
//             }  // trntdr(k) > p001 
           ...
           g_f32_out[ki] = rdir;  // layer reflectivity to direct radiation
           ki = ki + blockDim.x;
           g_f32_out[ki] = rdif_a; // layer reflectivity to diffuse radiation from above
           ki = ki + blockDim.x;
           ...
           //take care of this outside kernel
